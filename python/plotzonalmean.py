...
plt.contour(lats[:,0],np.arange(1,sigfile.nlevs+1),ugzm,clevs,colors='k',linewidths=0.5)
...
plt.contour(lats[:,0],np.arange(1,sigfile.nlevs+1),tempzm,clevs,colors='k',linewidths=0.5)
plt.contour(lats[:,0],np.arange(1,sigfile.nlevs+1),tempzm,[0],colors='k',linewidths=1.5)
