subroutine simple_physics (pcols, pver, dtime, lat, t, q, u, v, pmid, pint, pdel, rpdel, ps, precl, test, turbflux)
!----------------------------------------------------------------------- 
! 
...
!
   ...
   logical, intent(in)  :: turbflux     ! turbulent BL fluxes included
! turbflux = .false. means just large-scale condensation (test case 4.2)
